...
import { ChevronDown, ChevronUp, MoveRight, Calendar, TrendingUp, BarChart3, Pen, Trash, X, Check, ArrowUp, ArrowDown, RotateCcw } from "lucide-react";
  ...
  function ShadcnRadialProgress({
    ...
    const chartData = isOver 
      ? [
          ...
          { name: "remaining", value: Math.max(0, max - (value - max)), fill: "transparent" }
        ]
      : [
                ...
                <div className="flex-1 relative flex items-center">
                  <input
                    ...
                    onChange={(e) => setEditingGrams(Number(e.target.value))}
                      className="flex-1 h-1.5 rounded-full appearance-none cursor-pointer [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:w-5 [&::-webkit-slider-thumb]:h-5 [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-[#3B4361] [&::-webkit-slider-thumb]:cursor-pointer [&::-webkit-slider-thumb]:shadow-[0_0_0_0px_rgba(58,67,97,0)] [&::-webkit-slider-thumb]:hover:shadow-[0_0_0_10px_rgba(58,67,97,0.12)] [&:active::-webkit-slider-thumb]:shadow-[0_0_0_14px_rgba(58,67,97,0.15)] [&::-webkit-slider-thumb]:transition-shadow [&::-webkit-slider-thumb]:duration-150 [&::-moz-range-thumb]:w-5 [&::-moz-range-thumb]:h-5 [&::-moz-range-thumb]:rounded-full [&::-moz-range-thumb]:bg-[#3B4361] [&::-moz-range-thumb]:border-0 [&::-moz-range-thumb]:cursor-pointer [&:active::-moz-range-thumb]:box-shadow-[0_0_0_14px_rgba(58,67,97,0.15)]"
                    style={{
                      accentColor: "#3B4361",
                      ...
                      <>
                        ...
                        <>
                          <span className="text-subtitle-1-custom">
                            {type === "water" ? (value === 0 ? "0" : value.toLocaleString("it-IT", { minimumFractionDigits: 1, maximumFractionDigits: 1 })) : Math.round(value)}
                          </span>
                          <span className="text-body-sm-custom">
                            /{type === "processed" ? "100" : Math.round(target)}{type === "water" ? " liters" : type === "processed" ? "%" : "g"} <span className="text-title-custom">{name}</span>
                          </span>
                        </>
                    )}
                  </div>
            ...
            meals: [
              {
                ...
                totalCalories: 450,
                  foods: [
                    { name: "Skyr Bianco", grams: 150, calories: 95, pro: 16, carb: 6, fat: 0, fiber: 0, alcohol: 0, time: "08:30" },
                    { name: "Mandorle", grams: 30, calories: 180, pro: 6, carb: 6, fat: 15, fiber: 3, alcohol: 0, time: "08:35" },
                    { name: "Pane Integrale", grams: 50, calories: 175, pro: 6, carb: 35, fat: 1, fiber: 4, alcohol: 0, time: "08:40" },
                  ]
                },
                {
                  meal: "lunch",
                  totalCalories: 650,
                  foods: [
                    { name: "Pasta al Pomodoro", grams: 100, calories: 350, pro: 12, carb: 70, fat: 2, fiber: 3, alcohol: 0, time: "13:15" },
                    { name: "Insalata Mista", grams: 200, calories: 50, pro: 2, carb: 5, fat: 0, fiber: 4, alcohol: 0, time: "13:20" },
                    { name: "Petto di Pollo", grams: 150, calories: 250, pro: 45, carb: 0, fat: 5, fiber: 0, alcohol: 0, time: "13:25" },
                  ]
                },
                {
                  meal: "snack",
                  totalCalories: 200,
                  foods: [
                    { name: "Mela", grams: 200, calories: 104, pro: 1, carb: 28, fat: 0, fiber: 5, alcohol: 0, time: "16:45" },
                    { name: "Yogurt Greco", grams: 150, calories: 96, pro: 15, carb: 6, fat: 0, fiber: 0, alcohol: 0, time: "17:00" },
                  ]
                },
                {
                  meal: "dinner",
                  totalCalories: 500,
                  foods: [
                    { name: "Salmone", grams: 150, calories: 310, pro: 30, carb: 0, fat: 20, fiber: 0, alcohol: 0, time: "20:10" },
                    { name: "Verdure Grigliate", grams: 200, calories: 80, pro: 4, carb: 12, fat: 2, fiber: 6, alcohol: 0, time: "20:15" },
                    { name: "Pane Integrale", grams: 30, calories: 110, pro: 4, carb: 22, fat: 1, fiber: 3, alcohol: 0, time: "20:20" },
                  ]
              }
            ],
                    ...
                    <div className="flex flex-col w-full gap-3 pb-2">
                        <div className="flex gap-2">
                            <button
                              ...
                              className="flex-1 rounded-full text-center transition-all flex items-center justify-center px-3"
                              style={{
                                height: "32px",
                                backgroundColor: progressTab === "kcal" ? "#9EDDE2" : "#FFFFFF",
                                color: progressTab === "kcal" ? "#262C44" : "var(--text-secondary)",
                                fontSize: "0.875rem",
                                fontWeight: 700,
                              }}
                            >
                            ...
                            <button
                              ...
                              style={{
                                ...
                                color: progressTab === "macros" ? "#262C44" : "var(--text-secondary)",
                                fontSize: "0.875rem",
                                fontWeight: 700,
                              }}
                            >
                            ...
                            <div className="flex items-center gap-2 overflow-x-auto scrollbar-hide w-full pb-1">
                              ...
                              <button
                                ...
                                className="text-caption-custom transition-all whitespace-nowrap"
                                style={{
                                  display: "flex",
                                  height: "32px",
                                  padding: "0 12px",
                                  ...
                                  gap: "10px",
                                  borderRadius: "100px",
                                  backgroundColor: timeRange === range ? "var(--text-secondary)" : "#FFFFFF",

...
import { User2, ChevronDown, Search, Plus, Utensils, GlassWater, Footprints, Salad, Apple, Cookie } from "lucide-react";
      ...
      <div className="min-h-screen bg-gray-100 font-sans text-gray-900 overflow-y-auto scrollbar-hide">
        ...
        <div className="pb-3 flex gap-2 overflow-x-auto scrollbar-hide flex-nowrap">
                <button
                  ...
                  className={`flex items-center gap-2 rounded-full text-caption-custom transition-all whitespace-nowrap flex-shrink-0 ${
                    activeTab === "food"
